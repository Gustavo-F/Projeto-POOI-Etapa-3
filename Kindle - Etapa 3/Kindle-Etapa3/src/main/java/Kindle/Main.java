...
public class Main {
					...
					while(loopCliente == 1) {
						...
						case 1:
							...
							while(loopBiblioteca == 1) {
								...
								usuarioLogado.setBiblioteca(BibliotecaDAO.buscaBiblioteca(usuarioLogado));
								...
								case 2:
									...
									Livro livro = BibliotecaDAO.buscaLivroBiblioteca(usuarioLogado, LivroDAO.buscaPorTitulo(titulo));
									if(livro == null) {
								...
								case 3:
									...
									if(usuarioLogado.getBiblioteca().getLivros().size() == 0) {
										System.out.println("Biblioteca vazia.");
										break;
									}
									
									for(indice = 0; indice < usuarioLogado.getBiblioteca().getLivros().size() ; indice++) {
										System.out.println("\nID Livro: " + usuarioLogado.getBiblioteca().getLivros().get(indice).getIdLivro());
										System.out.println("Titulo: " + usuarioLogado.getBiblioteca().getLivros().get(indice).getTitulo());
										
										System.out.println("Escritor(es): ");
										for(int y = 0; y < usuarioLogado.getBiblioteca().getLivros().get(indice).getEscritores().size(); y++) {
											System.out.println(usuarioLogado.getBiblioteca().getLivros().get(indice).getEscritores().get(y).getNome()
													+ " " + usuarioLogado.getBiblioteca().getLivros().get(indice).getEscritores().get(y).getSobrenome());
										}
										
										System.out.println("Gênero(s): ");
										for(int x = 0; x < usuarioLogado.getBiblioteca().getLivros().get(indice).getGeneros().size(); x++) {
											System.out.println(usuarioLogado.getBiblioteca().getLivros().get(indice).getGeneros().get(x).getGenero());
										}
										
										System.out.println("Páginas: " + usuarioLogado.getBiblioteca().getLivros().get(indice).getPaginas());
										System.out.println("Editora: " + usuarioLogado.getBiblioteca().getLivros().get(indice).getEditora().getRazaoSocial());
									}
					...
					while(loopADM== 1) {
						...
						case 2:
							...
							while(loopEscritor == 1) {
								...
								case 4:
									...
									Escritor escritor = escritorDAO.buscaEscritor(id);
									if(escritor.getIdEscritor() == 0) {
										System.out.println("Escritor não cadastrado.");
										break;
									}
									
									System.out.println("\nID pessoa : " + escritor.getIdPessoa());
									System.out.println("ID do escritor: " + escritor.getIdEscritor());
									System.out.println("Nome: " +  escritor.getNome());
									System.out.println("Sobrenome: " + escritor.getSobrenome());
									System.out.println("CPF: " + escritor.getCPF());
									System.out.println("Email: " + escritor.getEmail());
									
									System.out.println("\nO que deseja fazer agora?");
									System.out.println("1 - Atualizar escritor");
									System.out.println("2 - Remover escritor");
									System.out.println("3 - Voltar");
									
									System.out.println("Informe a opção escolhida: ");
									int menuBuscaEscritor = leInt.nextInt();
									
									switch(menuBuscaEscritor) {
									case 1:
										atualizaEscritor(escritor);
										break;
										
									case 2:
										escritorDAO.remove(escritor);
										break;
						...
						case 3:
							...
							while(loopEditora == 1) {
								...
								case 4:
									...
									System.out.println("\nID da editora: " + editora.getIdPessoa());
									...
									System.out.println("1 - Atualizar editora");
									System.out.println("2 - Remover editora");
									System.out.println("3 - Voltar");
									
									System.out.println("Informe a opção escolhida: ");
									int menuBuscaEditora = leInt.nextInt();
									
									switch(menuBuscaEditora){
									case 1:
										atualizaEditora(editora);
										break;
						...
						case 4:
							...
							while(loopGeneros == 1) {
								...
								System.out.println("\n1 - Cadastrar gênero");
								System.out.println("2 - Remover gênero");
								System.out.println("3 - Listar gêneros");
								System.out.println("4 - Buscar gênero");
								System.out.println("5 - Atualizar gênero");
								System.out.println("6 - Voltar");
								...
								case 4:
									...
									Genero generoBusca = generoDAO.buscaGenero(genero);
									
									if(generoBusca.getGenero() == null) {
										System.out.println("Gênero não cadastrado.");
										break;
									}
									
									System.out.println("\nGênero: " + generoBusca.getGenero());
									
									System.out.println("\nO que deseja fazer?");
									System.out.println("1 - Atualizar gênero");
									System.out.println("2 - Remover gênero");
									System.out.println("3 - Voltar");
									
									System.out.println("Informe a opção escolhida:");
									int menuBuscaGenero = leInt.nextInt();
									
									switch(menuBuscaGenero) {
									case 1:
										atualizaGenero(generoBusca);
										break;
										
									case 2:
										generoDAO.remove(generoBusca);
										break;
								...
								case 5:
									...
									System.out.println("Gênero à ser atualizado: ");
									genero = leString.next();
									
									if(generoDAO.buscaGenero(genero).getGenero() == null) {
										System.out.println("Gênero não cadastrado.");
										break;
									}
									
									atualizaGenero(generoDAO.buscaGenero(genero));
	...
	private static void adicionaGeneroLivro(Livro livro) {
		...
		while(loop == 1) {
			...
			System.out.println("Adicionar outro gênero? (S/N)");
			String escolha = read.next();
	...
	private static void removeGeneroLivro(Livro livro){
		...
		while(loop == 1) {
			...
			System.out.println("Remover outro gênero? (S/N)");
			String escolha = read.next();
	...
	private static void atualizaLivro(Livro livro) {
		...
		System.out.println("4 - Adicionar gênero");
		System.out.println("5 - Remover escritor");
		System.out.println("6 - Remover gênero");
	...
	private static void atualizaGenero(Genero genero) {
		@SuppressWarnings("resource")
		Scanner read = new Scanner(System.in);
		GeneroDAO generoDAO = new GeneroDAO();
		
		System.out.println("Gênero:");
		String novoGenero = read.next();
		
		generoDAO.atualizaGenero(genero, novoGenero);		
	}
